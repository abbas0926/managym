...
const HandleClient = () => {
  ...
  useEffect(() => {
      const fetchCreneaux =  async () => {
         try {
            const result = await axios.get(`${process.env.REACT_APP_API_URL}/creneau/`)
...
const [creneau, setCreneau] = useState("");
  ...
  let endpoint = `${process.env.REACT_APP_API_URL}/clients/` //ENDPOINT TO GET THE MODEL INSTANCE LIKE HERE CLIENTS 
