...
class CreneauxSimpleSerialiser(serializers.ModelSerializer):
    ...
    class Meta:
        model = Creneau
        fields= ('id', 'hour_start', 'hour_finish', 'day', 'planning', 'activity', 'color', 'coach', 'width','coach_name', 'salle' )
...
class CreneauSerialiser(serializers.ModelSerializer):
    ...
    activtiy_name   = serializers.SerializerMethodField('get_activity_name', read_only= True)
    class Meta:
        model = Creneau
        fields= ('id', 'hour_start', 'hour_finish', 'day', 'planning', 'activity', 'color', 'coach', 'width','coach_name', 'salle', 'clients', 'clients_count', 'activtiy_name')
...
class CreneauClientSerialiser(serializers.ModelSerializer):
    ...
    color       = serializers.CharField(source='activity.color', read_only=True)
